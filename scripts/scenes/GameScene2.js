...
export default class GameScene2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.platforms.create(1450, 280, 'platform-small');
        this.platforms.create(1750, 340, 'platform-large');
        this.platforms.create(2050, 260, 'platform-large');
        this.platforms.create(2300, 280, 'platform-small');
        this.platforms.create(2550, 250, 'platform-small');
        this.platforms.create(2860, 340, 'platform-small');
        this.platforms.create(3200, 310, 'platform-large');
        this.platforms.create(3600, 250, 'platform-large');
        this.platforms.create(3960, 340, 'platform-small');
        this.platforms.create(4200, 300, 'platform-small');
        ...
        // Level label
        this.levelLabel = this.add.text(10, 50, 'Level: 2', { fontSize: '35px', fill: '#000' });
    ...
    finishLine(player, finish) {
        ...
        // Transition to GameScene3 after a delay
